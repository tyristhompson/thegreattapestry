...
function EditText({ isOpen, onClose, saveAnnotation, initialContent, title, previewTags, setPreviewTags, savedTags, setSavedTags, isEditing, onContentChange, noteId }) {
